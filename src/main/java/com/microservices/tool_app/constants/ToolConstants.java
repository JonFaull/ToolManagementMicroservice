...
public class ToolConstants extends BaseConstants {
    ...
    public static final String MESSAGE_417_UPDATE = "Tool update failed. Please try again or contact the Dev team";
    public static final String MESSAGE_417_DELETE = "Tool deletion failed. Please try again or contact the Dev team";
